...
from .forms import Account,UserProfile
...
from carts.views import Cart, CartItem
import requests
...
def register(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            send_email.send()
            #messages.success(request, 'Thank you for registering with us. We have send you a verification email to your email addess. Please verify it.')
